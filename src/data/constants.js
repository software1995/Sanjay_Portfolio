...
export const education = [
  ...
  {
    id: 2,
    "img": "../src/components/assets/school.jpg",
...
export const projects = [
  {
    ...
    image:
      "../src/components/assets/dummy.webp",
    projectCardsImages:
      "../src/components/assets/dummy.webp",
    tags: [
      "React Js",
...

  {
    ...
    image:
      "../src/components/assets/suniyenetajee.png",
    projectCardsImages: "../src/components/assets/suniyenetajee.png",
    tags: [
      "React Js",
      "REST APIs",
      "CI/CD",
  ...
  // },
  {
    ...
    description:
      "Frontend Development and Feature Implementation:- Spearheaded the creation of ClickNTokk using React Native,integrating a wide range of features such as video/photo sharing, messaging, voice communication, tagging, referrals,KYC, reels, comments, likes/dislikes, notifications, activity tracking, status updates, follow/unfollow, and advanced search functionalities. User Experience and Interface Design:-Designed a sleek, user-friendly interface with intuitive navigation, ensuring optimal performance across various devices for a consistent and engaging user experience Technology and Innovation: Utilized React Native for the frontend and Django with MongoDB for the backend to build robust systems supporting real-time interactions and secure data management. Enhanced user engagement with innovative elements like reels and advanced search capabilities.",
    images: [
      "../src/components/assets/clickntokk1.webp",
      "../src/components/assets/clickntokk2.webp",
      "../src/components/assets/clickntokk3.webp",
      "../src/components/assets/clickntokk4.webp",
      "../src/components/assets/clickntokk5.webp",

    ],
    projectCardsImages: "../src/components/assets/clickntokk0.webp",
  ...
  },
  {
    ...
    projectCardsImages: "../src/components/assets/Azzir0.webp",

    images: [
      // "../src/components/assets/Azzir1.webp",
      // "../src/components/assets/Azzir2.webp",
      // "../src/components/assets/Azzir3.webp",
      // "../src/components/assets/Azzir4.webp",
      // "../src/components/assets/Azzir5.webp",
      // "../src/components/assets/Azzir6.webp",
      // "../src/components/assets/Azzir7.webp",
      // "../src/components/assets/Azzir8.webp",
      // "../src/components/assets/Azzir9.webp",
      // "../src/components/assets/Azzir10.webp",
      // "../src/components/assets/Azzir11.webp",
      // "../src/components/assets/Azzir12.webp",

      "../components/assets/Azzir1.webp",
      "../components/assets/Azzir2.webp",
      "../src/components/assets/Azzir3.webp",
      "../src/components/assets/Azzir4.webp",
      "../src/components/assets/Azzir5.webp",
      "../src/components/assets/Azzir6.webp",
